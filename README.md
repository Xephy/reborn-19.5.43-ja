...
**82,475 / 82,568 行（99.9%）** を翻訳してあります。
...
Releases から `reborn-19.5.43-ja.5.zip` を取得し、ゲームのインストール先
...
これらを `Scripts/` へ書き戻し、コピーした `patch/` 以下の9つを削除すれば元通りです。
