...
意図的に残している 95 行があります。いずれも訳すべきでない箇所です。
...
同じ訳語で読める Pokémon Reborn の攻略を公開しています。

**<https://xephy.github.io/>**

[BIGJRA's Walkthroughs](https://bigjra.github.io/)（BIGJRA 氏）の攻略を翻訳したもので、
**訳語はこのパッチと同じ辞書から書き出しています**。ゲーム画面とサイトで
どうぐ名・わざ名・地名が食い違いません。

- 本編エピソード1〜19、クリア後エピソード1〜9、付録
- トレーナー戦 1,053件。手持ちのポケモン・わざ・とくせい・もちもの・せいかく・
  努力値・個体値まで。わざにはタイプと分類・威力・命中を併記
- 出現ポケモン 232表、ショップの品揃え 85表、隠しアイテムの場所を示す攻略図 261枚

攻略の本文と画像は BIGJRA 氏の著作物で、MIT ライセンスのもとで翻訳・公開しています。
